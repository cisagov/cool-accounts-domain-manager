...
issue](https://github.com/cisagov/cool-accounts-domain-manager/issues) in this
...
request](https://github.com/cisagov/cool-accounts-domain-manager/pulls), you
...
```console
cd cool-accounts-domain-manager
pyenv virtualenv <python_version_to_use> cool-accounts-domain-manager
pyenv local cool-accounts-domain-manager

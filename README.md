...
```hcl
module "example" {
  source = "github.com/cisagov/cool-accounts-domain-manager"
...
* [Deploying into the default VPC](https://github.com/cisagov/cool-accounts-domain-manager/tree/develop/examples/default_vpc)
